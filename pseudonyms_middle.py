...
def main():
    ...
    last = ('Appleyard', 'Bigmeat', 'Bloominshine', 'Boogerbottom',
            ...
            'Sugar-Gold', 'Swackhamer', 'Tippins', 'Turpinseed', 'Viniagrette',
            'Walkingstick', 'Wallbanger', 'Weewax', 'Weiners', 'Whipkey',
            'Wigglesworth', 'Wimplesnatch', 'Winterkorn', 'Woolysocks')

    middle = (' The Big News', ' Grunts', ' Tinkie Winkie', ' DumDum',
    ...
    while True:
        ...
        print("\n\n")
        # Trick Python by using "fatal error" setting to print name in red.
